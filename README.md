...
```bash
git clone https://github.com/Radiancenohook/recomby-geo-299.git
cd recomby-geo-299
python setup.py
```
...
| Skill | 来源 | 用途 |
|-------|------|------|
| `seo-geo-optimizer` | [199-biotechnologies](https://github.com/Radiancenohook/recomby-geo-299) (MIT) | 主力，13 个 Python 脚本 |
...
<!-- Last updated: 2026-06-06 19:52:44 -->
